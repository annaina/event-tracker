#ifndef EVENT_TRACKER__EVENT_H
#define EVENT_TRACKER__EVENT_H

// Event data types and HDF5 reader for Prophesee event cameras.
//
// Unchanged from the standalone project — this is pure data I/O,
// no ROS dependencies. The ROS node wraps this to publish EventArray
// messages.
